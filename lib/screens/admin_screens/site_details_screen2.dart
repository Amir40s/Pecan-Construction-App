...
import 'package:pecan_construction/screens/admin_screens/admin_controller/admin_site_detailsController.dart';
...
class SiteDetailsScreen_2 extends StatelessWidget {
  SiteDetailsScreen_2({super.key});
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Obx(() {
          ...
          final isActive =
              controller.siteStatus.value.trim().toLowerCase() == "active";
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                 CustomHeader(title: "site_details".tr, showBack: true),
                SizedBox(height: 4.h),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: isActive ? Colors.green : Colors.yellowAccent,
                          ),
                        ),
                        SizedBox(width: 1.w),
                        AppText(
                          controller.siteStatus.value.isEmpty
                              ? "-"
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return GestureDetector(
                      ...
                      child: AttachmentTile(
                        ...
                        subtitle: attachment.subtitle ?? 'N/A',
                        iconSvg: attachment.isPdf
                            ? AppIcons.pdfFileIcon
                            : AppIcons.fileIcon,
                        networkUrl: attachment.url,
                        isImageThumb: attachment.isImage,
                      ),
                    );
                  },
                )
